...
>
  ...
  Vertical with label
  <fieldset>
    <div id="ContactUsForm_ContactUsForm_FirstName_Holder" class="field text">
    ...
    <div id="ContactUsForm_ContactUsForm_LastName_Holder" class="field text">
    ...
    <div id="ContactUsForm_ContactUsForm_Email_Holder" class="field email text">
      <label class="left" for="ContactUsForm_ContactUsForm_Email">Email</label>
      <div class="middleColumn">
        <input
          type="email"
          name="Email"
    ...
    <div id="ContactUsForm_ContactUsForm_Phone_Holder" class="field text">
      <label class="left" for="ContactUsForm_ContactUsForm_Phone">Phone</label>
      <div class="middleColumn">
        <input
          type="text"
          name="Phone"
    ...
    <div id="ContactUsForm_ContactUsForm_CompanyName_Holder" class="field text">
    ...
    <div id="ContactUsForm_ContactUsForm_Message_Holder" class="field textarea">
...
ContactUsForm2ContactUsForm1111
